...
# installed.
TCL_PREFIX='/home/scifaipy/dev/compas/moonlander-visualization/conda'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/scifaipy/dev/compas/moonlander-visualization/conda'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/scifaipy/dev/compas/moonlander-visualization/conda/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/tk_1645033378611/work=/usr/local/src/conda/tk-8.6.12 -fdebug-prefix-map=/home/scifaipy/dev/compas/moonlander-visualization/conda=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/scifaipy/dev/compas/moonlander-visualization/conda/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,--allow-shlib-undefined -Wl,-rpath,/home/scifaipy/dev/compas/moonlander-visualization/conda/lib -Wl,-rpath-link,/home/scifaipy/dev/compas/moonlander-visualization/conda/lib -L/home/scifaipy/dev/compas/moonlander-visualization/conda/lib -Wl,--export-dynamic '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/scifaipy/dev/compas/moonlander-visualization/conda/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/scifaipy/dev/compas/moonlander-visualization/conda/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/scifaipy/dev/compas/moonlander-visualization/conda/include'
...
# compiled.
TCL_SRC_DIR='/home/scifaipy/dev/compas/moonlander-visualization/conda/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/home/scifaipy/dev/compas/moonlander-visualization/conda/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/scifaipy/dev/compas/moonlander-visualization/conda/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/scifaipy/dev/compas/moonlander-visualization/conda/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/scifaipy/dev/compas/moonlander-visualization/conda/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/scifaipy/dev/compas/moonlander-visualization/conda/lib/libtclstub8.6.a'
